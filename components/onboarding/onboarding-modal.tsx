...
const STEPS = [
  {
    ...
    detail: [
      '📄 LaTeX source with full PDF preview',
      '✏️ Edit body content or full LaTeX preamble',
      '💾 Auto-saved to local storage on every keystroke',
    ],
  },
  {
    step: 2,
  ...
  },
  {
    ...
    detail: [
      ...
      '⚡ Tailor Resume (guarded by your profile)',
      '🔍 Review Changes in diff viewer → Export PDF',
    ],
  },
];
      ...
      <div className='relative w-full max-w-lg bg-[#111] border border-white/10 rounded-3xl shadow-2xl overflow-hidden'>
        ...
        <div className='px-6 pb-6 space-y-5'>
          ...
          <div className='flex items-center gap-4'>
            <div className='flex-shrink-0 w-14 h-14 rounded-2xl bg-accent/10 border border-accent/20 flex items-center justify-center text-accent'>
              {step.icon}
            </div>
            <div>
